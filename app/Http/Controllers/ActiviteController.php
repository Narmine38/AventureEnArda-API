...
class ActiviteController extends Controller
{
    ...
    {
        $activites = Activite::with('lieu')->get();
     ...
     * @return JsonResponse
     */
    public function archivedActivite(): JsonResponse
    {
        // Récupère uniquement les activites qui sont "soft deleted" avec leur relation "lieu"
        $activite = Activite::onlyTrashed()->with('lieu')->get();
     ...
     * @return JsonResponse
     */
    public function showArchivedActivite(string $id): JsonResponse
    {
